...
///
/// Додатково:
/// - RowNo — монотонний номер рядка (генерується БД).
///   Використовується як стабільний "time-order" для обчислення останнього стану особи:
///   ORDER BY RowNo DESC.
/// </summary>
public sealed class CombatTaskEntry
{
    /// <summary>
    /// PK запису (технічний ідентифікатор).
    /// </summary>
    public Guid Id { get; set; }

    /// <summary>
    /// Монотонний номер рядка (identity / generated by DB).
    /// Дозволяє швидко та просто брати "останній" запис по особі.
    /// </summary>
