...
using eRaven.Application.DTOs.CombatTasks.Models;
using eRaven.Presentation.Toasts;
using Microsoft.AspNetCore.Components;
using Microsoft.AspNetCore.Components.Forms;

namespace eRaven.Components.Pages.CombatTasks.Drawers;
...
public partial class CreateDocumentDrawer
{
    ...
    // DI
    //==========================
    [Inject] public ICommandHandler<CreateCombatTaskDocumentCommand, Guid> CreateCombatTaskDocumentCommandHandler { get; set; } = default!;
    ...
    private async Task SubmitAsync()
    {
        ...
        try
        {
            ...
            var docId = await CreateCombatTaskDocumentCommandHandler.HandleAsync(new CreateCombatTaskDocumentCommand(
