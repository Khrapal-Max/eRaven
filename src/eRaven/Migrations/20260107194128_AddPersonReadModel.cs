...
{
    /// <inheritdoc />
    public partial class AddPersonReadModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnrollmentKind = table.Column<int>(type: "integer", nullable: false),
                    EnrollmentReference = table.Column<string>(type: "text", nullable: true),
                    ...
                    planned_position = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    ...
                    temporary_position = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
