        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    position_name = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    bzvp = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    weapon = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    callsign = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_plan_actions_plans_plan_id",
                        column: x => x.plan_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    plan_id = table.Column<Guid>(type: "uuid", nullable: false),
                    plan_action_id = table.Column<Guid>(type: "uuid", nullable: false),
                    person_id = table.Column<Guid>(type: "uuid", nullable: false),
                    action_type = table.Column<int>(type: "integer", nullable: false),
                    event_at_utc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    location = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_order_actions", x => x.id);
                    table.ForeignKey(
                        name: "FK_order_actions_orders_order_id",
                        column: x => x.order_id,
                        principalTable: "orders",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_order_actions_persons_person_id",
                        column: x => x.person_id,
                        principalTable: "persons",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_order_actions_plan_actions_plan_action_id",
                        column: x => x.plan_action_id,
                        principalTable: "plan_actions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_order_actions_plans_plan_id",
                        column: x => x.plan_id,
                        principalTable: "plans",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_order_actions_order_id",
                table: "order_actions",
                column: "order_id");

            migrationBuilder.CreateIndex(
                name: "ix_order_actions_order_person",
                table: "order_actions",
                columns: new[] { "order_id", "person_id" });

            migrationBuilder.CreateIndex(
                name: "IX_order_actions_person_id",
                table: "order_actions",
                column: "person_id");

            migrationBuilder.CreateIndex(
                name: "IX_order_actions_plan_id",
                table: "order_actions",
                column: "plan_id");

            migrationBuilder.CreateIndex(
                name: "ux_order_actions_plan_action_id",
                table: "order_actions",
                column: "plan_action_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_plan_actions_person_last",
                table: "plan_actions",
                columns: new[] { "person_id", "event_at_utc" });

            migrationBuilder.CreateIndex(
                name: "ix_plan_actions_plan_person_last",
                table: "plan_actions",
                columns: new[] { "plan_id", "person_id", "event_at_utc" });
