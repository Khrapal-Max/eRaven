...
namespace eRaven.Migrations
{
    ...
    [Migration("20260125192344_AddCombatTask")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eRaven.Domain.Entities.CombatTaskAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PlanningDocTitle")
                        .IsRequired()
                        .HasMaxLength(250)
                    ...
                    b.Property<string>("PositionalArea")
                        .IsRequired()
                        .HasMaxLength(140)
                        .HasColumnType("character varying(140)");
                    ...
                    b.HasIndex("PlanningDate", "PersonId");

                    b.ToTable("combat_task_assignments", null, t =>
                        {
                            t.HasCheckConstraint("ck_combat_task_assignment_dates", "\"EndedAt\" IS NULL OR \"EndedAt\" >= \"StartedAt\"");
                        });
                });

            modelBuilder.Entity("eRaven.Domain.Entities.CombatTaskPlanDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PlanningDate", "Status");

                    b.ToTable("combat_task_plan_documents", (string)null);
                });

            modelBuilder.Entity("eRaven.Domain.Entities.CombatTaskPlanLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PersonId", "ActionDate");

                    b.HasIndex("DocumentId", "PersonId", "Kind")
                        .IsUnique();

                    b.ToTable("combat_task_plan_lines", (string)null);
                });
            ...
            modelBuilder.Entity("eRaven.Domain.Entities.CombatTaskPlanLine", b =>
                {
                    b.HasOne("eRaven.Domain.Entities.CombatTaskPlanDocument", "Document")
                        .WithMany("Lines")
