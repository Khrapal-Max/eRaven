...
namespace eRaven.Migrations
{
    ...
    [Migration("20250915144611_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eRaven.Domain.Models.PlanParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("eRaven.Domain.Models.PlanParticipantAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("PlanParticipantId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("EventAtUtc")
                        .HasDatabaseName("ix_actions_event_at");

                    b.HasIndex("PlanParticipantId", "ActionType")
                        .IsUnique()
                        .HasDatabaseName("ux_actions_participant_type");

                    b.ToTable("plan_participant_actions", (string)null);
                });
            ...
            modelBuilder.Entity("eRaven.Domain.Models.PlanServiceOptions", b =>
                {
                    ...
                    b.Property<int?>("DispatchStatusKindId")
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("ReturnStatusKindId")
                        .HasColumnType("integer")
                        .HasColumnName("return_status_kind_id");

                    b.HasKey("Id");

                    b.HasIndex("DispatchStatusKindId")
                        .HasDatabaseName("ix_plan_opts_dispatch_kind");

                    b.HasIndex("ReturnStatusKindId")
                        .HasDatabaseName("ix_plan_opts_return_kind");

                    b.ToTable("plan_service_options", null, t =>
                        {
                            t.HasCheckConstraint("ck_plan_opts_dispatch_ne_return", "(dispatch_status_kind_id IS NULL) OR (return_status_kind_id IS NULL) OR (dispatch_status_kind_id <> return_status_kind_id)");
                        });
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ModifiedUtc = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
            ...
            modelBuilder.Entity("eRaven.Domain.Models.PlanParticipantAction", b =>
                {
                    b.HasOne("eRaven.Domain.Models.PlanParticipant", "PlanParticipant")
                        .WithMany("Actions")
                        .HasForeignKey("PlanParticipantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PlanParticipant");
                });

            modelBuilder.Entity("eRaven.Domain.Models.PlanServiceOptions", b =>
                {
                    b.HasOne("eRaven.Domain.Models.StatusKind", "DispatchStatusKind")
                        .WithMany()
                        .HasForeignKey("DispatchStatusKindId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("eRaven.Domain.Models.StatusKind", "ReturnStatusKind")
                        .WithMany()
                        .HasForeignKey("ReturnStatusKindId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("DispatchStatusKind");

                    b.Navigation("ReturnStatusKind");
                });
