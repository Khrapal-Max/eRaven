...
namespace eRaven.Migrations
{
    ...
    [Migration("20260227130944_AddCombatTaskDocument")]
    partial class AddCombatTaskDocument
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eRaven.Domain.Entities.CombatTaskDetails", b =>
                {
                    ...
                    b.ToTable("combat_task_details", (string)null);
                });
            ...
            modelBuilder.Entity("eRaven.Domain.Entities.MissionAssignment", b =>
                {
                    ...
                    b.ToTable("mission_assignments", null, t =>
                        {
                            t.HasCheckConstraint("ck_mission_assignments_end_source_consistency", "(to_date IS NULL AND source_end_document_id IS NULL AND source_end_details_id IS NULL) OR (to_date IS NOT NULL AND source_end_document_id IS NOT NULL AND source_end_details_id IS NOT NULL)");

                            t.HasCheckConstraint("ck_mission_assignments_to_gt_from", "to_date IS NULL OR to_date > from_date");
                        });
                });
