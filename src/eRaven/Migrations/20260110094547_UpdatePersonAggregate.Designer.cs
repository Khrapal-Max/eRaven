...
namespace eRaven.Migrations
{
    ...
    [Migration("20260110094547_UpdatePersonAggregate")]
    partial class UpdatePersonAggregate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eRaven.Domain.Entities.PersonReadModel", b =>
                {
                    ...
                    b.Property<Guid?>("PlannedPositionUnitId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("TemporaryPositionUnitId")
                        .HasColumnType("uuid");
