...
namespace eRaven.Migrations
{
    ...
    [Migration("20250916141129_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eRaven.Domain.Models.OrderAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("OrderId", "PersonId")
                        .HasDatabaseName("ix_order_actions_order_person");

                    b.ToTable("order_actions", (string)null);
                });
            ...
            modelBuilder.Entity("eRaven.Domain.Models.PlanAction", b =>
                {
                    ...
                    b.HasIndex("PersonId", "EventAtUtc")
                        .HasDatabaseName("ix_plan_actions_person_last");

                    b.HasIndex("PlanId", "PersonId", "EventAtUtc")
            ...
            modelBuilder.Entity("eRaven.Domain.Models.OrderAction", b =>
                {
                    b.HasOne("eRaven.Domain.Models.Order", "Order")
                        .WithMany("Actions")
                    ...
                    b.HasOne("eRaven.Domain.Models.PlanAction", null)
                        .WithMany()
