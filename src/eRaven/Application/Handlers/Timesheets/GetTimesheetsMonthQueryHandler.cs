...
/// </summary>
public sealed class GetTimesheetsMonthQueryHandler(
    ITimesheetViewRepository repo,
    IPersonRepository persons)
    : IQueryHandler<GetTimesheetsMonthQuery, IReadOnlyList<TimesheetPersonRangeRowDto>>
{
