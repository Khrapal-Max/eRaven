    ...
    : ITimesheetEntryWriterRepository
{
        ...
        CancellationToken ct = default)
    {
        ...
        ep.CorrectionTimesheetEntry(entryId, nextCodeId, nextEffectiveAt, reference, author.Trim(), nowUtc);
        ...
        CancellationToken ct = default)
    {
        ...
        if (active is not null && active.From == effectiveAt)
        {
            ...
            {
                ep.CorrectionTimesheetEntry(active.Id, nextCodeId, effectiveAt, reference, author.Trim(), nowUtc);
            }
        }
        else
        {
            ep.AddTimesheetEntry(nextCodeId, effectiveAt, reference, author.Trim(), nowUtc);
        }
